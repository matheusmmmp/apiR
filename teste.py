    ...
    if historico_partidas:
        ...
        for partida in historico_partidas:
            ...
            for times in dataPartida['teams']:
                ...
                print(f"Time {corTime} - Resultado: {resultado} - Totais de Objetivos: Dragão:{contadorObjetivos['dragon']['kills']} Campeões:{contadorObjetivos['champion']['kills']} Barão:{contadorObjetivos['baron']['kills']} Torres:{contadorObjetivos['tower']['kills']} Arauto:{contadorObjetivos['riftHerald']['kills']}")
